...
const LatestActivities = () => {
    ...
    const { data: dealsData, isLoading: isLoadingDeals } = useList({
        resource: 'deals',
    ...
    return (
        <Card
            style={{ padding: '16px', paddingBottom: '0 1rem' }}
            title={
        ...
        >
            {isLoading ? (
                ...
                <List
                    ...
                    renderItem={(item) => {
                        const deal = dealsData?.data?.find((deal) => deal.id === String(item.targetId));
                                ...
                                <List.Item.Meta
                                    ...
                                    description={
                                        <Space size={4}>
                                            ...
                                            <Text>{item.action === 'CREATE' ? 'created' : 'updated'}</Text>
